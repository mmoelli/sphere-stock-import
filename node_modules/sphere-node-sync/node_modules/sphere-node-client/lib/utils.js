...
module.exports = {
  ...
  buildQueryString: function(opts) {
    var limitParam, offsetParam, page, perPage, queryString, sort, where, whereOperator, whereParam, _ref;
    if (opts == null) {
      opts = {};
    }
    _ref = _.defaults(opts, {
      ...
      whereOperator: 'and',
      sort: []
    }), where = _ref.where, whereOperator = _ref.whereOperator, sort = _ref.sort, page = _ref.page, perPage = _ref.perPage;
